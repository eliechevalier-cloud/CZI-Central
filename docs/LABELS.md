...
| marketing | `#FFFF00` (Yellow) | Marketing campaigns and promotional activities |
| web | `#00FF00` (Green) | Website updates and online presence |
...
gh label create "marketing" --color "FFFF00" --description "Marketing campaigns and promotional activities"
gh label create "web" --color "00FF00" --description "Website updates and online presence"
